...
\usepackage{xcolor}
\usepackage{hyperref}
% Uncomment the lines bellow to use TileWallPaper
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight,clip]{Sprites.png}}
\frame{
...
{
\usebackgroundtemplate{\ThisTileWallPaper{95.3pt}{95.3pt}{dark_brick_wall.png}}    
\frame{
\frametitle{Tiling Background}
Text here
}
}
